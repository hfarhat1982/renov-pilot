...
const ACTIONS: Action[] = [
  {
    ...
    response: {
      ...
      sections: [
        {
          title: "Points conformes",
          items: [
            "TVA correctement détaillée (10% rénovation)",
            "Décaissement chiffré en m³ avec évacuation des gravats",
            "Mention du planning prévisionnel",
          ],
        },
        {
          title: "Points à clarifier",
          items: [
            "Préciser l'épaisseur du dallage béton armé prévu",
            "Demander si le ferraillage est inclus ou en supplément",
        ...
        },
        {
          ...
          items: [
            "Devis à 8 400 € vs budget prévu 8 000 € (+5%)",
            "Acceptable si la prestation inclut bien l'évacuation",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          title: "Critique",
          items: [
            "Étanchéité périphérique extérieure / drainage",
            "Reprise éventuelle en sous-œuvre selon étude G2",
            "Détection radon (zone potentiellement concernée)",
          ],
        },
        {
          title: "À vérifier",
          items: [
            "Hauteur sous plafond après finitions (mini 2,20 m)",
            "Apport de lumière naturelle / puits de jour",
            "Issue de secours conforme pour pièce habitable",
          ],
        },
        {
          title: "Confort",
          items: [
            "Déshumidificateur d'appoint pendant les 6 premiers mois",
            "Renforcement acoustique plafond",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          items: [
            ...
            "Attestations décennale + RC pro de chaque artisan",
            "DICT si terrassement à plus de 40 cm",
          ],
        },
        {
          title: "Technique",
          items: [
            "Mise hors d'eau provisoire vérifiée",
            "Coupure générale eau/électricité repérée",
            "Protection des sols et accès",
          ],
        },
        {
          title: "Sécurité",
          items: [
            "EPI obligatoires pour visiteurs",
            "Affichage consignes incendie",
  ...
  },
  {
    ...
    response: {
      ...
      sections: [
        {
          title: "Objet",
          items: ["Demande de devis — Traitement humidité sous-sol semi-enterré (35 m²)"],
        },
        {
          title: "Contexte",
          items: [
            "Projet d'aménagement en pièce habitable",
            "Étude de sol G2 disponible sur demande",
            "Présence d'auréoles d'humidité ponctuelles (angle SE)",
          ],
        },
        {
          title: "Demande",
          items: [
            "Préconisations : cuvelage vs drainage périphérique",
            "Devis détaillé poste par poste, avec garantie décennale",
            "Délai d'intervention souhaité : septembre 2026",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          items: [
            "Maître d'ouvrage",
            "Maçonnerie Dupuis & Fils",
            "Bureau d'études BTP Solutions Sol",
          ],
        },
        {
          title: "Constats",
          items: [
            "Hauteur disponible : 2,48 m brut → 2,28 m après dalle isolée",
            "Mur nord : trace d'humidité ancienne, support sain",
            "Évacuation existante : insuffisante, station de relevage requise",
          ],
        },
        {
          title: "Actions",
          items: [
            "Devis traitement humidité à demander d'ici 15 jours",
            "Plans cotés à finaliser pour la mairie",
            "Prochaine visite : J+30",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          title: "Faisabilité",
          items: [
            "Quelle station de relevage recommandez-vous pour WC + douche ?",
        ...
        },
        {
          title: "Mise en œuvre",
          items: [
            "Comment gérez-vous le passage des canalisations en sous-sol ?",
            "Quels matériaux pour les évacuations (PVC, PER) ?",
            "Prévoyez-vous un clapet anti-retour ?",
          ],
        },
        {
          title: "Engagement",
          items: [
            ...
            "Garanties proposées (décennale, biennale) ?",
      ...
      sections: [
        {
          title: "Projet",
          items: [
            "Aménagement d'un sous-sol semi-enterré de 35 m² en pièce habitable",
            "Budget cible : 30 000 € · démarrage prévu mars 2026",
          ],
        },
        {
          title: "Lots clés",
          items: [
            "Étude de sol G2 (validée)",
            "Maçonnerie + décaissement (devis reçu)",
            "Traitement humidité, plomberie, station de relevage (à chiffrer)",
          ],
        },
        {
          title: "Risques identifiés",
          items: [
            "Humidité — point critique",
            "Hauteur sous plafond limite",
            "Dépassement potentiel du budget maçonnerie",
          ],
        },
      ],
    },
